...
import LegionsProEchartsLine from '..';
...
class LegionsProEchartsLineMouter extends React.Component{
    // @ts-ignore
...
class LegionsProEchartsLineAutoMouter extends React.Component{
    // @ts-ignore
...
describe('折线图',() => {
    ...
    it('getEchartsInstance',() => {
        const component = mount(<LegionsProEchartsLineMouter
        ></LegionsProEchartsLineMouter>);
        expect(component.instance()).not.toBe(null)
        expect(component.instance().lineRef.id.substring(0,3)).toBe('ec_')
    })
    it('default props line',()=>{
        const component = mount(<LegionsProEchartsLineMouter></LegionsProEchartsLineMouter>)
    ...
    it('autoQuery',()=>{
        const component = mount(<LegionsProEchartsLineAutoMouter></LegionsProEchartsLineAutoMouter>)
        expect(component.exists()).toBe(true)
        expect(component.find('div').length).toBe(1)
        expect(component.getDOMNode().nodeName.toLowerCase()).toBe('div');
