 ...
 * @Description: 饼图组件
 * @FilePath: /legions-design-element/packages/legions-pro-echarts/src/components/LegionsProEchartsCard/index.tsx
 * @「扫去窗上的尘埃，才可以看到窗外的美景。」
 */
...
/** 卡片组件 */
export default class LegionsProEchartsCard extends React.Component<LegionsProEchartsCardProps>{
