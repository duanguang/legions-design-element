...
/** 仪表盘组件 */
var LegionsProEchartsChartGauge = /** @class */ (function (_super) {
    __extends(LegionsProEchartsChartGauge, _super);
    function LegionsProEchartsChartGauge() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Object.defineProperty(LegionsProEchartsChartGauge.prototype, "option", {
        /** 配置项 */
        get: function () {
            return {
                tooltip: {
    ...
    LegionsProEchartsChartGauge.prototype.render = function () {
    ...
    LegionsProEchartsChartGauge.defaultProps = new LegionsProEchartsGaugeProps();
    return LegionsProEchartsChartGauge;
}(React.PureComponent));

export default LegionsProEchartsChartGauge;
