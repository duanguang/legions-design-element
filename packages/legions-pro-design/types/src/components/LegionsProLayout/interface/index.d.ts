...
export declare type globalUserType<T> = {
    userName: string;
    userUid: string;
    companyName?: string;
    companyUid?: string;
...
export declare type openPaneParamesType = Pick<panesInterface, 'key' | 'title' | 'path' | 'params' | 'forceRefresh'> & {
...
/** 菜单组件props约束 */
export interface menuPartsProps extends Pick<legionsProLayoutMainProps, 'userEntity' | 'logo' | 'onQueryPromiseMenus' | 'defaultOpenMenuTabs' | 'domainUrl' | 'router' | 'defaultOpenKeys' | 'onLogoClick' | 'fixedLayoutPosition' | 'loadedMenuTransformData'>, MenuProps {
    store?: InstanceType<typeof LegionsStoreLayout.MenuStore>;
}
/** headerPart组件props约束 */
export interface headerPartProps extends Pick<legionsProLayoutMainProps, 'userEntity' | 'onLoginOut' | 'sysSettingDropdown' | 'header' | 'isReCustomHeader' | 'fixedLayoutPosition'> {
    skin?: string;
    store?: InstanceType<typeof LegionsStoreLayout.MenuStore>;
}
/** content组件props约束 */
export interface contentPartProps extends Pick<legionsProLayoutMainProps, 'userEntity' | 'router' | 'isEnabledTabs' | 'domainUrl' | 'notFoundUrl' | 'fixedLayoutPosition'> {
