 ...
 * @LastEditTime: 2021-02-02 23:05:30
 * @LastEditors: duanguang
 * @Description: 
 * @FilePath: /legions-design-element/packages/legions-pro-design/src/components/LegionsProQueryConditions/ProConditionsUtils.tsx
 * @「扫去窗上的尘埃，才可以看到窗外的美景。」
 */
...
export interface IProConditions {
    ...
    ConditionTextModel | ConditionDateModel | ConditionRangePickerModel |ConditionSearchModel
}
