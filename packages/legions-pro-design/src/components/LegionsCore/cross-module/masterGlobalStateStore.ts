 ...
 * @LastEditTime: 2021-03-03 10:20:16
 * @LastEditors: duanguang
 * @Description: 
 * @FilePath: /legions-design-element/packages/legions-pro-design/src/components/LegionsCore/cross-module/masterGlobalStateStore.ts
 * @「扫去窗上的尘埃，才可以看到窗外的美景。」
 */
