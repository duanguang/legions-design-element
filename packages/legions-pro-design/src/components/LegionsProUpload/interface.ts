/*
 * @Author: duanguang
 * @Date: 2020-12-26 22:36:22
 * @LastEditTime: 2020-12-26 22:36:57
 * @LastEditors: duanguang
 * @Description: 
 * @FilePath: /legions-design-element/packages/legions-pro-design/src/components/LegionsProUpload/interface.ts
 * @「扫去窗上的尘埃，才可以看到窗外的美景。」
 */
import { UploadChangeParam,UploadFile,UploadProps } from '../interface/antd';
