 ...
 * @LastEditTime: 2020-12-26 14:39:31
 * @LastEditors: duanguang
 * @Description: 
 * @FilePath: /legions-design-element/packages/legions-pro-design/src/components/services/pro.table/api/index.ts
 * @「扫去窗上的尘埃，才可以看到窗外的美景。」
 */
...
import { ContainerEntity } from '../../../models/pro.base.model';
