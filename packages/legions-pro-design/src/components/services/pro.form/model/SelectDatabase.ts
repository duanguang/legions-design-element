 ...
 * @LastEditTime: 2020-12-29 10:29:48
 * @LastEditors: duanguang
 * @Description: 
 * @FilePath: /legions-design-element/packages/legions-pro-design/src/components/services/pro.form/model/SelectDatabase.ts
 * @「扫去窗上的尘埃，才可以看到窗外的美景。」
 */
...
export class SelectDatabaseDB extends Database {
  //@ts-ignore
  public selectItem: Dexie.Table<ISelectDatabaseDB, number>; // id is number in this case
