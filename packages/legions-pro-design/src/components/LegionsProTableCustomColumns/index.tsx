                                    ...
                                    options={{
                                        ...
                                        store: {
                                            ...
                                            get: (sortable) => {
                                                ...
                                                return this.viewStore.getLocalStorageShowColumns()
                                            },
                                            ...
                                            set: (sortable) => {
                                                ...
                                                this.viewStore.setLocalStorageShowColumns(this.props.customColumnsConfig.editApi)
                                            }
                                        }
                                    }}
                                    onChange={(items) => {
