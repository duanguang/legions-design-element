 ...
 * @「扫去窗上的尘埃，才可以看到窗外的美景。」
 */
var NoAccess = require('../assets/images/wZcnGqRDyhPOEYFcZDnb.png');
var NoFound = require('../assets/images/KpnpchXsobRgLElEozzI.png');
var ServerError = require('../assets/images/RVRUAYdCGeYNBWoKiIwB.png');
var config = {
    403: {
        img: NoAccess,
        title: '403',
