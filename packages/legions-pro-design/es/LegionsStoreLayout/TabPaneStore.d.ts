...
export default class TabPaneViewStore extends LegionsStore.StoreBase {
    ...
    addTabPanes(panes: IPanes, menuList: Array<InstanceType<typeof LegionsModels.MenuEntity>>): void;
    /**
     ...
     * @memberof TabPaneViewStore
     */
    openDefault(defaultItem: Pick<IPanes, 'key' | 'keyPath' | 'path' | 'title'>, menuList: Array<InstanceType<typeof LegionsModels.MenuEntity>>): void;
    /**
     ...
     * @memberof TabPaneViewStore
     */
    setDefaultTabPanes(defaultItem: any, menuList: Array<InstanceType<typeof LegionsModels.MenuEntity>>): void;
    /**
     * 设置活动页签
     *
     * @param {*} activeKey
     ...
     * @memberof TabPaneViewStore
     */
    syncTabPanes(menuList: Array<InstanceType<typeof LegionsModels.MenuEntity>>): void;
}
