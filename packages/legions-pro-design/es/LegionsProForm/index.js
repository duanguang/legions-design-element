...
var ProFormFields = /** @class */ (function () {
  ...
  */
    ProFormFields.responseBodyToFormFields = function (formFields, data) {
        // @ts-ignore
        var result = {};
        ...
        Object.keys(model).forEach(function (key) {
            // @ts-ignore
            var meta = getFormMetaProperty(model, key);
            var requestKey = meta && meta.requestKey || key;
            if (meta && meta['beforeDataToFormFields'] &&
                typeof meta['beforeDataToFormFields'] === 'function') {
                result[key] = meta['beforeDataToFormFields'](data[requestKey], data);
            }
            else {
   ...
   * @memberof
   */
    ProFormFields.formFieldsToRepuestBody = function (values) {
        // @ts-ignore
        var result = {};
        Object.keys(values).forEach(function (key) {
            // @ts-ignore
            var meta = getFormMetaProperty(values, key);
            var requestKey = meta && meta.requestKey || key;
            var ignore = false;
            ...
            if (meta && meta['submitBeforeTransform'] &&
                typeof meta['submitBeforeTransform'] === 'function') {
                result[requestKey] = meta['submitBeforeTransform'](values[key], values);
            }
            else {
...
var CustomizedForm = Form.create({
    mapPropsToFields: function (props) {
        ...
        if (!props.mapPropsToFields) {
            return __assign(__assign({}, props), originFormModel);
        }
        return props.mapPropsToFields(__assign(__assign({}, props), originFormModel));
    },
