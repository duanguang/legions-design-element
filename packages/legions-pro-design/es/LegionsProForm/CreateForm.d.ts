...
export default abstract class CreateForm<Props, State> extends React.Component<Props, State> {
    ...
    protected createFormRangePicker(key: number | string, control: LabelWithRangePickerModel, form: WrappedFormUtils, formUid: string, formRef: InstanceForm): JSX.Element;
    protected createFormUpload(key: number | string, control: LabelWithUploadModel, form: WrappedFormUtils, formUid: string, formRef: InstanceForm): JSX.Element;
    protected createFormSwitch(key: number | string, control: LabelWithSwitchModel, form: WrappedFormUtils, formUid: string, formRef: InstanceForm): JSX.Element;
    protected createFormRadioButton(key: number | string, control: LabelWithRadioButtonModel, form: WrappedFormUtils, formUid: string, formRef: InstanceForm): JSX.Element;
    protected createFormText(key: number | string, control: LabelWithTextModel, form: WrappedFormUtils, formUid: string, formRef: InstanceForm): JSX.Element;
    protected createFormCheckbox(key: number | string, control: LabelWithCheckboxModel, form: WrappedFormUtils, formUid: string, formRef: InstanceForm): JSX.Element;
}
