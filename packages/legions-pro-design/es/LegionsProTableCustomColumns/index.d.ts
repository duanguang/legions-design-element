...
export default class LegionsProTableCustomColumns extends Component<IProps, IState> {
    ...
    get viewStore(): import("brain-store-utils/types/create-view-model").ViewModel<import("../LegionsProTable/store/ProTableView").ProTableView> & {
        userInfo: {
            userName: string;
            userUid: string;
            companyName?: string;
        ...
        columns?: import("../LegionsProTable/interface").ITableColumnConfigProps<{}>[];
        _obTableListCustom: import("../LegionsModels/pro.table.model").TableColumnsContainerEntity;
        tableBodyDomClientHeight: number;
        bodyExternalContainer: import("../LegionsProTable/store/ProTableView").IObservableMap<string, {
            height: number;
        }>;
        ...
        readonly computedShowColumns: import("../LegionsProTable/store/ProTableView").IShowColumns[];
        readonly computedUnShowColumns: import("../LegionsProTable/store/ProTableView").IShowColumns[];
        readonly computedStorageShowColumnsKeys: string;
        readonly computedRenderColumns: import("../LegionsProTable/interface").ITableColumnConfigProps<{}>[];
        ...
        _getLocalStorageShowColumns: () => import("../LegionsProTable/store/ProTableView").IShowColumns[];
